...
│   │   │                   #   GenerationConfig, DatabaseConfig, RedisConfig), UIConfig
│   │   │                   #   с текстами кнопок; единственная точка чтения окружения
...
│   │   ├── evaluation_fsm.py      # состояния оценки/фидбека и обогащения промпта
